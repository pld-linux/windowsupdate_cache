...
Są to skrypty używane przez autora do cache'owania plików z witryny
Microsoftu (włączając Windows Update). Należy zauważyć, że to nie jest
"klon" serwisu windowsupdate, tylko prosty sposób na nie ściąganie
ponownie plików, które są już w magazynie. Proszę przeczytać załączony
plik README z instrukcją użycia.
...
To jest bazujący na apache magazyn dla windowsupdate_cache.
